...
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(6),eta=integer(0.06)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(6),eta=integer(0.08)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(6),eta=integer(0.1)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(6),eta=integer(0.12)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(6),eta=integer(0.14)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(6),eta=integer(0.16)))

trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(5),eta=integer(0.06)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(5),eta=integer(0.08)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(5),eta=integer(0.1)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(5),eta=integer(0.12)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(5),eta=integer(0.14)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(5),eta=integer(0.16)))

trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(7),eta=integer(0.06)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(7),eta=integer(0.08)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(7),eta=integer(0.1)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(7),eta=integer(0.12)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(7),eta=integer(0.14)))
trials<-rbind(trials,data.frame(ntree=integer(50),depth=integer(7),eta=integer(0.16)))
