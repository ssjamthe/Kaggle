...
clf = GradientBoostingRegressor(n_estimators=15000,max_depth=8,min_samples_split=10,min_samples_leaf=2,max_features="auto",verbose=1,random_state=1988)
clf.fit(ftTrain,yTrain)

#Ktrain : 1.0
#cvPred : 0.601842786603
...
joblib.dump(clf,"GBMModel15000_5_sameCvMat/GBMModel15000_5_sameCvMat")


clf = GradientBoostingRegressor(n_estimators=14999,max_depth=8,min_samples_split=30,min_samples_leaf=10,max_features="auto",verbose=1,random_state=1988)
clf.fit(ftTrain,yTrain)
...
joblib.dump(clf,"GBMModel14999_5_sameCvMat/GBMModel14999_5_sameCvMat")